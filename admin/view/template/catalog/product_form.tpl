        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-techspecs<?php echo $language['language_id']; ?>"><?php echo $entry_techspecs; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][techspecs]" placeholder="<?php echo $entry_description; ?>" id="input-techspecs<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['techspecs'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-highlights<?php echo $language['language_id']; ?>"><?php echo $entry_highlights; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][highlights]" placeholder="<?php echo $entry_description; ?>" id="input-highlights<?php echo $language['language_id']; ?>">
                        <?php 
                          echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['highlights'] : ''; 
                        ?>
                        </textarea>
                    </div>
                  </div>
                  ...
                  <legend><?php echo $text_custom_field; ?> #1</legend>
                  <div class="form-group">
                    <label for="input-custom_field_1_title<?php echo $language['language_id']; ?>" class="col-sm-2 control-label"><?php echo $entry_custom_field_title; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][custom_field_1_title]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['custom_field_1_title'] : ''; ?>" placeholder="<?php echo $entry_custom_field_title ?>" id="input-custom_field_1_title<?php echo $language['language_id']; ?>" class="form-control">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="input-custom_field_1_content<?php echo $language['language_id']; ?>" class="col-sm-2 control-label"><?php echo $entry_custom_field_content; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id'] ?>][custom_field_1_content]" placeholder="<?php  echo $entry_custom_field_content ?>" id="input-custom_field_1_content<?php echo $language['language_id']; ?>" class="form-control">
                        <?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['custom_field_1_content'] : ''; ?>
                      </textarea>
                    </div>
                  </div>

                  <legend><?php echo $text_custom_field; ?> #2</legend>
                  <div class="form-group">
                    <label for="input-custom_field_2_title<?php echo $language['language_id']; ?>" class="col-sm-2 control-label"><?php echo $entry_custom_field_title; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][custom_field_2_title]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['custom_field_2_title'] : ''; ?>" placeholder="<?php echo $entry_custom_field_title ?>" id="input-custom_field_2_title<?php echo $language['language_id']; ?>" class="form-control">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="input-custom_field_2_content<?php echo $language['language_id']; ?>" class="col-sm-2 control-label"><?php echo $entry_custom_field_content; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id'] ?>][custom_field_2_content]" placeholder="<?php  echo $entry_custom_field_content ?>" id="input-custom_field_2_content<?php echo $language['language_id']; ?>" class="form-control">
                        <?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['custom_field_2_content'] : ''; ?>
                      </textarea>
                    </div>
                  </div>

                  <legend><?php echo $text_custom_field; ?> #3</legend>
                  <div class="form-group">
                    <label for="input-custom_field_3_title<?php echo $language['language_id']; ?>" class="col-sm-2 control-label"><?php echo $entry_custom_field_title; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][custom_field_3_title]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['custom_field_3_title'] : ''; ?>" placeholder="<?php echo $entry_custom_field_title ?>" id="input-custom_field_3_title<?php echo $language['language_id']; ?>" class="form-control">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="input-custom_field_3_content<?php echo $language['language_id']; ?>" class="col-sm-2 control-label"><?php echo $entry_custom_field_content; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id'] ?>][custom_field_3_content]" placeholder="<?php  echo $entry_custom_field_content ?>" id="input-custom_field_3_content<?php echo $language['language_id']; ?>" class="form-control">
                        <?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['custom_field_3_content'] : ''; ?>
                      </textarea>
                    </div>
                  </div>
                </div>
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-model">Molpir ID</label>
                <div class="col-sm-10">
                  <input type="text" name="external_url_id" value="<?php echo $external_url_id; ?>" placeholder="<?php echo $external_url_id; ?>" id="input-external_url_id" class="form-control" />
                </div>
              </div>           
              <div class="form-group required">
            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-breakup">
                  <?php echo $entry_breakup; ?>
                </label>
                <div class="col-sm-10">
                  <?php foreach($product_categories as $key => $value) { ?>
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1"><?php echo $value['name']; ?></span>
                    <input type="text" class="form-control" placeholder="<?php echo $value['position'] ?>" value="<?php echo $value['position'] ?>" name="product_position[<?php echo $value['category_id'] ?>]">
                  </div>
                  <?php } ?>
                </div>
              </div>
...
<?php foreach ($languages as $language) { ?>
  ...
  $('#input-techspecs<?php echo $language['language_id']; ?>').summernote({height: 200});
  $('#input-highlights<?php echo $language['language_id']; ?>').summernote({height: 200});
  $('#input-custom_field_1_content<?php echo $language['language_id'] ?>').summernote({height: 200});
  $('#input-custom_field_2_content<?php echo $language['language_id'] ?>').summernote({height: 200});
  $('#input-custom_field_3_content<?php echo $language['language_id'] ?>').summernote({height: 200});
<?php } ?>
//--></script> 
  <script type="text/javascript"><!--
// Manufacturer
