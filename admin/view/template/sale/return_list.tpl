          ...
          <div class="row">
            ...
            <div class="col-sm-3">
              ...
              <div class="form-group">
                ...
                <input type="text" name="filter_ecv" value="<?php echo $filter_ecv; ?>" placeholder="<?php echo $entry_ecv; ?>" data-date-format="YYYY-MM-DD" id="input-ecv" class="form-control" />
              </div> 
            </div>
            <div class="col-sm-3">
              <div class="form-group">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right" style="min-width: 110px;">
                    <div class="btn-group">
                      <a href="<?php echo $return['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary" style="margin-right: 5px;"><i class="fa fa-pencil"></i>
                      </a>
                      <a href="<?php echo $return['details'] ?>" data-toggle="tooltip" title="<?php echo $button_details; ?>" class="btn btn-primary print-store"><i class="fa fa-file-o"></i>
                      </a> 
                    </div>
                  </td>
                </tr>
