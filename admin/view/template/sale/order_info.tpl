...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <a href="<?php echo $warranty; ?>" target="_blank" data-toggle="tooltip" title="<?php echo $button_warranty_print; ?>" class="btn btn-info"><i class="fa fa-star"></i></a>
...
$(document).delegate('.button-customfield', 'click', function() {

  var button = $(this);
  var input  = $(this).siblings('.input-customfield').val();
  var field  = $(this).parent('div').data('field');

  $.ajax({
    url: 'index.php?route=sale/order/setCustomOrderField&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>&' + field + '=' + input,
    dataType: 'json',
    beforeSend: function() {
    ...
    success: function(json) {
      $('div[data-field="' + field + '"]').children('.span-customfield').html(json);
    },
    error: function(xhr, ajaxOptions, thrownError) {
      $('div[data-field="' + field + '"]').children('.span-customfield').html(input);
    }
  });
});
