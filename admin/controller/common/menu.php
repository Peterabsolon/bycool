...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['warranty'] = $this->url->link('sale/warranty', 'token=' . $this->session->data['token'], 'SSL');
		$data['service_centre'] = $this->url->link('sale/service_centre', 'token=' . $this->session->data['token'], 'SSL');
