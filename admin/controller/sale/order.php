...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		$data['warranty'] = $this->url->link('sale/order/warranty', 'token=' . $this->session->data['token'], 'SSL');
	...
	public function getForm() {
		...
		$data['text_warranty_no'] = $this->language->get('text_warranty_no');
		$data['text_warranty_serial'] = $this->language->get('text_warranty_serial');
	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['text_warranty_no'] = $this->language->get('text_warranty_no');
			$data['text_warranty_serial'] = $this->language->get('text_warranty_serial');
			$data['text_servis_centre'] = $this->language->get('text_servis_centre');
			$data['text_vehicle_type'] = $this->language->get('text_vehicle_type');
			$data['text_ecv'] = $this->language->get('text_ecv');
			$data['text_vin_num'] = $this->language->get('text_vin_num');
			$data['text_compressor_num'] = $this->language->get('text_compressor_num');
			$data['text_date_install'] = $this->language->get('text_date_install');
			...
			$data['button_invoice_print'] = $this->language->get('button_invoice_print');
			$data['button_shipping_print'] = $this->language->get('button_shipping_print');
			$data['button_warranty_print'] = $this->language->get('button_warranty_print');
			$data['button_edit'] = $this->language->get('button_edit');
			$data['button_cancel'] = $this->language->get('button_cancel');
			...
			$data['warranty'] = $this->url->link('sale/order/warranty', 'token=' . $this->session->data['token'] . '&order_id=' . (int)$this->request->get['order_id'], 'SSL');
			...
			$data['warranty_no'] = $order_info['warranty_no'];
			$data['warranty_serial'] = $order_info['warranty_serial'];

			$data['servis_centre'] = $order_info['servis_centre'];
			$data['vehicle_type'] = $order_info['vehicle_type'];
			$data['ecv'] = $order_info['ecv'];
			$data['vin_num'] = $order_info['vin_num'];
			$data['compressor_num'] = $order_info['compressor_num'];
			...
			$data['date_installed'] = $order_info['date_installed'];
	...
	public function setCustomOrderField() {
		...
		if (!$this->user->hasPermission('modify', 'sale/order')) {
			...
			$new_value = $this->model_sale_order->setCustomOrderField($keys[3], $order_id, $this->request->get[$keys[3]]);
			print_r($new_value);
			die;

			if ($this->request->get[$keys[3]]) {
				$json[$keys[3]] = $this->request->get[$keys[3]];
			} else {
				$json['error'] = $this->language->get('error_action');
			}
		}
	...
	public function warranty() {
		...
		$data['title'] = $this->language->get('text_warranty');
		...
		$data['text_warranty_no'] = $this->language->get('text_warranty_no');
		$data['text_warranty_detail'] = $this->language->get('text_warranty_detail');
		$data['text_servis_centre'] = $this->language->get('text_servis_centre');
		$data['text_warranty_serial'] = $this->language->get('text_warranty_serial');
		$data['text_vehicle_type'] = $this->language->get('text_vehicle_type');
		$data['text_ecv'] = $this->language->get('text_ecv');
		$data['text_vin_num'] = $this->language->get('text_vin_num');
		$data['text_compressor_num'] = $this->language->get('text_compressor_num');
		$data['text_date_installed'] = $this->language->get('text_date_install');
		...
		// Warranty stuff
		$data['warranty']   			= $this->language->get('text_warranty');
		$data['warranty_no'] 			= $this->language->get('text_warranty_no');
		$data['warranty_serial'] 	= $this->language->get('text_warranty_serial');
		$data['servis_centre'] 		= $this->language->get('text_servis_centre');
		$data['vehicle_type'] 		= $this->language->get('text_vehicle_type');
		$data['ecv'] 							= $this->language->get('text_ecv');
		$data['vin_num'] 					= $this->language->get('text_vin_num');
		$data['compressor_num'] 	= $this->language->get('text_compressor_num');
		$data['date_install'] 		= $this->language->get('text_date_install');
		...
		foreach ($orders as $order_id) {
			...
			if ($order_info && $order_info['shipping_code']) {
				...
				if ($order_info['warranty_no']) {
					$data['warranty']['warranty_no'] = $order_info['warranty_no'];
				}

				if ($order_info['warranty_serial']) {
					$data['warranty']['warranty_serial'] = $order_info['warranty_serial'];
				}

				if ($order_info['servis_centre']) {
					$data['warranty']['servis_centre'] = $order_info['servis_centre'];
				}

				if ($order_info['vehicle_type']) {
					$data['warranty']['vehicle_type'] = $order_info['vehicle_type'];
				}

				if ($order_info['ecv']) {
					$data['warranty']['ecv'] = $order_info['ecv'];
				}

				if ($order_info['vin_num']) {
					$data['warranty']['vin_num'] = $order_info['vin_num'];
				}

				if ($order_info['compressor_num']) {
					$data['warranty']['compressor_num'] = $order_info['compressor_num'];
				}

				if ($order_info['date_installed']) {
					$data['warranty']['date_installed'] = $order_info['date_installed'];
				}
		...
		$this->response->setOutput($this->load->view('sale/order_warranty.tpl', $data));
	}
