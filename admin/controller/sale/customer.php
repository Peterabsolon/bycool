...
class ControllerSaleCustomer extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['contact_email'])) {
			...
			$data['contact_email'] = $customer_info['contact_email'];
		} else {
			$data['contact_email'] = '';
		}
	...
	protected function validateForm() {
		...
		if ($this->request->post['discount'] < 0 || $this->request->post['discount'] > 99) {
			$this->error['discount'] = $this->language->get('error_discount');	
		}

		if ((utf8_strlen($this->request->post['email']) < 1) || (utf8_strlen(trim($this->request->post['email'])) > 32)) {
