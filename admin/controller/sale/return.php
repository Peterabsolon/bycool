...
class ControllerSaleReturn extends Controller {
	...
	protected function getList() {
		...
		$data['sort_return_code'] = $this->url->link('sale/return', 'token=' . $this->session->data['token'] . '&sort=r.return_code' . $url, 'SSL');
		...
		$data['sort_order_code'] = $this->url->link('sale/return', 'token=' . $this->session->data['token'] . '&sort=r.order_code' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('sale/return', 'token=' . $this->session->data['token'] . '&sort=status' . $url, 'SSL');
		$data['sort_ecv'] = $this->url->link('sale/return', 'token=' . $this->session->data['token'] . '&sort=r.ecv' . $url, 'SSL');
