...
class ControllerUserUser extends Controller {
	...
	protected function getForm() {
		...
		$data += $this->language->load('common/header');
		...
		if (isset($this->request->post['user_service_centre_id'])) {
			$data['user_service_centre_id'] = $this->request->post['user_service_centre_id'];
		} else if(!empty($user_info)) {
			$data['user_service_centre_id'] = $user_info['user_service_centre_id'];
		} else {
			$data['user_service_centre_id'] = '';
		}
		...
		if (isset($this->request->post['firstname'])) {
			...
			$data['firstname'] = $user_info['user_firstname'];
		} else {
			$data['firstname'] = '';
		}
		...
		if (isset($this->request->post['lastname'])) {
			...
			$data['lastname'] = $user_info['user_lastname'];
		} else {
			$data['lastname'] = '';
		}
