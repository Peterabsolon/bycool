...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_name'] = $this->language->get('entry_name');
		$data['entry_breakup'] = $this->language->get('entry_breakup');
		$data['entry_description'] = $this->language->get('entry_description');
		$data['entry_techspecs'] = $this->language->get('entry_techspecs');
		$data['entry_highlights'] = $this->language->get('entry_highlights');
		...
		$data['entry_custom_field_title'] = $this->language->get('entry_custom_field_title');
		$data['entry_custom_field_content'] = $this->language->get('entry_custom_field_content');
		...
		if (isset($this->request->post['external_url_id'])) {
			$data['external_url_id'] = $this->request->post['external_url_id'];
		} elseif (!empty($product_info)) {
			$data['external_url_id'] = $product_info['external_url_id'];
		} else {
			$data['external_url_id'] = '';
		}
		...
		foreach ($categories as $category_id) {
			...
			if ($category_info) {
				if (isset($this->request->get['product_id'])) {
					$breakup_id = $this->model_catalog_category->getBreakupId($category_id, $this->request->get['product_id']);	
