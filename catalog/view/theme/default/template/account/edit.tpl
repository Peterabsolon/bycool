        ...
        <div class="panel-body">
          <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            <fieldset>
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-email">Login</label>
                <div class="col-sm-10">
                  <input type="text" name="email" value="<?php echo $email; ?>" placeholder="Login" id="input-email" class="form-control" />
                  <?php if ($error_login) { ?>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-contact_email"><?php echo $entry_email; ?></label>
                <div class="col-sm-10">
                  <input type="email" name="contact_email" value="<?php echo $contact_email; ?>" placeholder="<?php echo $entry_email; ?>" id="input-contact_email" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
