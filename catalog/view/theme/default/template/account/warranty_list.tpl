...
<div class="container-fluid">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i style="font-size: 18px; color: #fff" class="fa fa-plus" style="color: #fff"></i></a>
        <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-warranty').submit() : false;"><i style="font-size: 18px; color: #fff" class="fa fa-trash-o" style="color: #fff"></i></button>
      </div>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left">
                    <div class="btn-group">
                      <a href="<?php echo $warranty['print'] ?>" data-toggle="tooltip" title="<?php echo $button_print_warranty; ?>" class="btn btn-primary btn-sm print-store" style="margin: 0 3px;"><i class="fa fa-print" style="font-size: 16px;"></i></a> 
                      </a>
                    </div>
                  </td>
                  <?php /* <td class="text-right"><?php echo $warranty['warranty_id']; ?></td> */ ?>
...
$('#button-filter').on('click', function() {
  url = 'index.php?route=account/warranty';
