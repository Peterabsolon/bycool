...
class ModelAccountCustomer extends Model {
	...
	public function addGuestCustomer($data) {
		$customer_group_id = 9999;

		$this->db->query("
			INSERT INTO " . DB_PREFIX . "customer 
			SET customer_group_id = '" . (int)$customer_group_id . "',
					newsletter 				= '1', ip = '" . $this->db->escape($this->request->server['REMOTE_ADDR']) . "', status = '1'");
	...
	public function editCustomer($data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "customer SET firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', email = '" . $this->db->escape($data['email']) . "', contact_email = '" . $this->db->escape($data['contact_email']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', fax = '" . $this->db->escape($data['fax']) . "', custom_field = '" . $this->db->escape(isset($data['custom_field']) ? serialize($data['custom_field']) : '') . "' WHERE customer_id = '" . (int)$customer_id . "'");
