<?php
class ModelAccountWarranty extends Model {
	public function addWarranty($data, $customer_id) {
		$this->db->query("
	...
	public function editWarranty($warranty_id, $data, $customer_id) {
		$this->db->query("
	...
	public function getWarranties($data = array()) {
		...
		if (!empty($data['filter_customer_id'])) {
			$implode[] = "w.customer_id = '" . $this->db->escape($data['filter_customer_id']) . "'";
		}
