...
class ControllerAccountWarranty extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->model_account_warranty->addWarranty($this->request->post, $customer_id);
			...
			$this->response->redirect($this->url->link('account/warranty', $url, 'SSL'));
		}
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->model_account_warranty->editWarranty($this->request->get['warranty_id'], $this->request->post, $customer_id);
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['warranties'][] = array(
				...
				'print'						 => $this->url->link('account/warranty/printWarranty&version=store&lang=slovak', '&warranty_id=' . $result['warranty_id'] . $url, 'SSL' )
			);
		}
		...
		$data['sort_warranty_id'] = $this->url->link('account/warranty', '&sort=w.warranty_id' . $url, 'SSL');
		$data['sort_warranty_code'] = $this->url->link('account/warranty', '&sort=w.warranty_code' . $url, 'SSL');
		$data['sort_customer'] = $this->url->link('account/warranty', '&sort=customer' . $url, 'SSL');
		$data['sort_client'] = $this->url->link('account/warranty', '&sort=w.customer_name' . $url, 'SSL');
		$data['sort_product'] = $this->url->link('account/warranty', '&sort=w.product' . $url, 'SSL');
		$data['sort_ecv'] = $this->url->link('account/warranty', '&sort=w.ecv' . $url, 'SSL');
		$data['sort_order_code'] = $this->url->link('account/warranty', '&sort=w.order_code' . $url, 'SSL');
		$data['sort_serial_number'] = $this->url->link('account/warranty', '&sort=w.serial_number' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('account/warranty', '&sort=w.date_added' . $url, 'SSL');
		$data['sort_date_modified'] = $this->url->link('account/warranty', '&sort=w.date_modified' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('account/warranty', $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		$data += $this->load->language('account/warranty');
